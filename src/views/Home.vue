<template>
  <div class="home">
    ...
    <div class="reg">
      <router-link to="/login" target="self"
        ><button id="login">LOG IN</button></router-link
      >
      <router-link to="/register" target="self"
        ><button id="signup">SIGN UP</button></router-link
      >
    </div>
    <img src="../assets/startup.svg" class="startup_image"/>
